...
INSERT INTO event(event_id, name, event_date, venue, max_count) VALUES (106, 'Public Speaking', SYSDATE()+INTERVAL 4 DAY, 'B5-Hall', 2);
...
INSERT INTO participant(participant_id, name, email_id, gender, registration_date, event_id) VALUES (1011, 'Ron', 'ron@infy.com', 'Male', SYSDATE()-INTERVAL 3 DAY, 103);
INSERT INTO participant(participant_id, name, email_id, gender, registration_date, event_id) VALUES (1012, 'Harry', 'harry@infy.com', 'Male', SYSDATE()-INTERVAL 1 DAY, 103);
